...
public class PromotionDataResponse {
    ...
    public PromotionDataResponse() {
    }

    public PromotionDataResponse(int id, String promoId, String title, boolean isApply, Date startDate, Date endDate, boolean status, String cover, double startRank, double endRank) {
        this.id = id;
