...
public class PromotionProductResponse {
    ...
    public PromotionProductResponse(int id, String promoId, String title, boolean isApply, Date startDate, Date endDate, boolean status, String cover, double startRank, double endRank) {
        this.id = id;
