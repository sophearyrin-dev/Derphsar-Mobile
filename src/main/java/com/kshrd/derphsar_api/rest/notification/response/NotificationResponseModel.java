package com.kshrd.derphsar_api.rest.notification.response;
...
public class NotificationResponseModel {
    ...
    public NotificationResponseModel(int id, String sender_id, String receiver_id, Object noti, String noti_type, String role_sender, Timestamp timestamp, boolean is_read) {
        this.id = id;
